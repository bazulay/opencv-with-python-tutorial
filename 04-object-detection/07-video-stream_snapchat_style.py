...
def populate_globals(idx):
    ...
    print("height_adjustment = {}".format(height_adjustment))
    width_adjustment  = w_adjustments[idx]
    print("width_adjustment = {}".format(width_adjustment))
    resize_adjustment = resize_adjustments[idx]
    print("resize_adjustment = {}".format(resize_adjustment))
    ear_index = idx
    print("ear_index = {}".format(ear_index))
    if idx == 0:
        return
